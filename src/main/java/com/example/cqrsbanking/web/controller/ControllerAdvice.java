...
import com.example.cqrsbanking.web.dto.MessageDto;
...
public class ControllerAdvice {
    ...
    public MessageDto validation(
        ...
        Map<String, String> errors = e.getBindingResult()
            .getFieldErrors()
            .stream()
            .collect(Collectors.toMap(FieldError::getField, DefaultMessageSourceResolvable::getDefaultMessage, (existingResult, newMessage)-> existingResult + " " + newMessage));
