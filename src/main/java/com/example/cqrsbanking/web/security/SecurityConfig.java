...
import com.example.cqrsbanking.web.security.jwt.JwtTokenFilter;
...
public SecurityFilterChain filterChain(
    ...
    security
        ...
        ) // Закрывающая скобка для exceptionHandling
        .authorizeHttpRequests(configurer ->
            configurer.requestMatchers("/api/v*/auth/**").permitAll().anyRequest().authenticated()
        )
